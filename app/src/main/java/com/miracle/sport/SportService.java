...
public interface SportService {
     ...
     */
    @Headers({"BaseUrl:zh"})
    @POST("home/Rebate/tieziCommentList")
     ...
     */
    @Headers({"BaseUrl:zh"})
    @POST("home/Rebate/sendTieziComment")
...
//    @POST("home/fish/click")
     ...
     */
    @Headers({"BaseUrl:zh"})
    @POST("home/Rebate/deleteComment")
